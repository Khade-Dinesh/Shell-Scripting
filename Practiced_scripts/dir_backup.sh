...
#This script take backup of directory through the arg.
...
# Check if valid directory path is provided as a command-line argumnet 
if [ $# -eq 0 ] || [ ! -d "$1" ];
then 
	echo "Error:Please provide a valid directory path as commnand line argument"
	display_usage
	exit 1
fi
